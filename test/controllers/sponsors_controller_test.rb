...
class SponsorsControllerTest < ActionController::TestCase
  ...
  test "should create sponsor" do
    assert_difference('Sponsor.count') do
      post :create, sponsor: { logo_url: @sponsor.logo_url, name: @sponsor.name, web_address: @sponsor.web_address }
    end
  ...
  test "should update sponsor" do
    patch :update, id: @sponsor, sponsor: { logo_url: @sponsor.logo_url, name: @sponsor.name, web_address: @sponsor.web_address }
    assert_redirected_to sponsor_path(assigns(:sponsor))
  end
